				...
				<form id="user_form">
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							...
							<input type="designation" id="designation" name="designation" class="form-control" required>
						</div>
						<div class="form-group">
							<label>SALARY</label>
			...
			<div class="modal-content">
				<form id="update_form">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>SALARY</label>
							<input type="number" id="salary_u" name="salary" class="form-control" required>
						</div>
						<div class="form-group">
							<label>DATE</label>
